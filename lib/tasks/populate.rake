...
namespace :db do
  ...
  task :populate => :environment do
    ...
    count.times do 
      ...
      submission = Submission.create(:user => user, :name => Faker::Commerce.product_name, :body => Faker::Lorem.paragraph, :type => ['Vehicle', 'Map', 'Misc', 'Weapon'].sample, :approved_at => Time.now)
